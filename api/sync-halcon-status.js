 ...
 *
 * Invocado por cron de Vercel cada 10 minutos.
 * También puede llamarse manualmente desde curl/Postman.
 *
 * Auth: Vercel pasa Authorization: Bearer {CRON_SECRET} en crons.
 *       Si CRON_SECRET no está configurado, el endpoint es abierto.
 */
